  ...
  _createClass(Portal, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.closeOnOutsideClick) {
        this.registerCloseOnOutsideClickHandler();
      }
    ...
    value: function componentWillReceiveProps(newProps) {
      ...
      if (newProps.closeOnOutsideClick !== this.props.closeOnOutsideClick) {
        // Was false, now true
        if (newProps.closeOnOutsideClick) {
          this.registerCloseOnOutsideClickHandler();
        } else {
          // Was true, now false
          this.unRegisterCloseOnOutsideClickHandler();
        }
      }
    }
  }, {
    ...
    key: 'registerCloseOnOutsideClickHandler',
    value: function registerCloseOnOutsideClickHandler() {
      document.addEventListener('mouseup', this.handleOutsideMouseClick);
      document.addEventListener('touchstart', this.handleOutsideMouseClick);
    }
  }, {
    key: 'unRegisterCloseOnOutsideClickHandler',
    value: function unRegisterCloseOnOutsideClickHandler() {
